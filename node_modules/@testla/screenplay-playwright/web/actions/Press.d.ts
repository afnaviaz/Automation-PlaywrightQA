 ...
 */
export declare class Press extends FrameEnabledAction {
    private mode;
    private payload;
    private constructor();
    /**
     ...
     * @return {Press} new Press instance
     */
    static sequentially(selector: Selector, input: string, options?: SelectorOptions): Press;
}
