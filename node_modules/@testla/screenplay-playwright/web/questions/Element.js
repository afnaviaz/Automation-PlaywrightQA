...
class Element extends FrameEnabledQuestion_1.FrameEnabledQuestion {
    ...
    answeredBy(actor) {
        return __awaiter(this, void 0, void 0, function* () {
            const { mode, selector, payload, checkMode, options, frameTree, } = this;
            if (mode === 'visible') {
                const locator = yield BrowseTheWeb_1.BrowseTheWeb.as(actor).resolveSelectorToLocator(selector, Object.assign(Object.assign({}, options), { state: checkMode === 'positive' ? 'visible' : 'hidden' }), frameTree);
            ...
            if (mode === 'enabled') {
                const locator = yield BrowseTheWeb_1.BrowseTheWeb.as(actor).resolveSelectorToLocator(selector, options, frameTree);
                if (this.checkMode === 'positive') {
            ...
            if (mode === 'count') {
                const locator = yield BrowseTheWeb_1.BrowseTheWeb.as(actor).resolveSelectorToLocator(selector, Object.assign(Object.assign({}, options), { evaluateVisible: false }), frameTree);
                if (this.checkMode === 'positive') {
            ...
            if (mode === 'minCount') {
                if (checkMode === 'positive') {
                    yield BrowseTheWeb_1.BrowseTheWeb.as(actor).resolveSelectorToLocator(`${selector} >> nth=${payload - 1}`, options, frameTree);
                }
                else {
                    yield BrowseTheWeb_1.BrowseTheWeb.as(actor).resolveSelectorToLocator(`${selector} >> nth=${payload - 1}`, Object.assign(Object.assign({}, options), { state: 'hidden' }), frameTree);
                }
